...
public class Bean {
    ...
    private String tid,tname,tphone,temail,tcenter,trstatus;
    private String shid,shname,shaddress,shphone;
    private String prid,prname,prprice,primage,prdesc;
    ...
    public String getTcenter() {
        return tcenter;
    }

    public void setTcenter(String tcenter) {
